...
export default function Training() {
  return (
    <Flex maxW="100%" minH="762px" gap="72px" flexWrap="wrap" pt={{base: "0", sm: "15rem", md: "0"}} >
      ...
      <Flex maxW="1274px" minH="136px" flexWrap="wrap" mx="auto" pt={{base: "5rem", md: "auto"}} gap={{base: "1.5rem", md: "0"}}>
        <Text maxW="608px" minH="120px" fontWeight="600" fontSize="3rem" lineHeight="60px" color={{base: "#061C3D", _dark: "#3E90F0"}} textAlign={{base: "center", md: "start"}} mx={{base: "auto", md: "initial"}}>Why Choose This Training?</Text>
        <Flex flexDirection="column" maxW="569px" minH="136px" gap="24px" alignItems={{base: "center", md: "normal"}} mx="auto">
